...
namespace Framework
{
    public class FTuVanSanPhams
    {
        #region UPDATE STATUS
        public bool UPDATESTATUS(string ino, string istatus)
        {
            SqlConnection conn = Database.Connection();
            SqlCommand comm = new SqlCommand("S_TuVanSanPham_Updatestatus", conn);
            ...
            try
            {
                ...
                objtran.Commit();
                System.Web.HttpContext.Current.Cache.Remove("TuVanSanPham");
                return true;
            }
            catch
            {
        ...
        #region GET BY ID
        public List<TuVanSanPham> GETBYID(string Id)
        {
            SqlConnection conn = Database.Connection();
            SqlCommand comm = new SqlCommand("S_TuVanSanPham_ID", conn);
            comm.CommandType = CommandType.StoredProcedure;
            comm.Parameters.Add(new SqlParameter("@ino", Id));
            try
            {
                return Database.Bind_List_Reader<TuVanSanPham>(comm);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        #region GET BY ALL
        public List<TuVanSanPham> GETBYALL(string Lang)
        {
            SqlConnection conn = Database.Connection();
            SqlCommand comm = new SqlCommand("S_TuVanSanPham_GetByAll", conn);
            comm.CommandType = CommandType.StoredProcedure;
        ...
        #region INSERT
        public bool Insert(TuVanSanPham obj)
        {
            SqlConnection conn = Database.Connection();
            SqlCommand comm = new SqlCommand("S_TuVanSanPham_Insert", conn);
            comm.CommandType = CommandType.StoredProcedure;
            SqlTransaction objtran = conn.BeginTransaction();
            comm.Transaction = objtran;
        ...
        #region UPDATE
        public bool Update(TuVanSanPham obj)
        {
            SqlConnection conn = Database.Connection();
            SqlCommand comm = new SqlCommand("S_TuVanSanPham_Update", conn);
            comm.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlConnection conn = Database.Connection();
            SqlCommand comm = new SqlCommand("S_TuVanSanPham_Delete", conn);
            comm.CommandType = CommandType.StoredProcedure;
            comm.Parameters.Add(new SqlParameter("@ino", Id));
            SqlTransaction objtran = conn.BeginTransaction();
            comm.Transaction = objtran;
        ...
        public List<TuVanSanPham> CATEGORY_ADMIN(string lang, string istatus)
        {
            string sql = @"select * from TuVanSanPham where lang='" + lang + "'";
            if (!istatus.Equals("-1"))
            {
        ...
        public List<TuVanSanPham> Name_StoredProcedure(string Name_StoredProcedure)
        {
            SqlConnection conn = Database.Connection();
        ...
        #region Name Text
        public List<TuVanSanPham> Name_Text(string Name_Text)
        {
            SqlConnection conn = Database.Connection();
