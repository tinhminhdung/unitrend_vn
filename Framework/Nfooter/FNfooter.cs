...
namespace Framework
{
    ...
    {
        public List<Nfooter> CATEGORY(string icid, string lang, string Status)
        {
            List<Nfooter> list;
        ...
        public List<Nfooter> CATEGORYADMIN(string orderby, string searchkeyword, string[] searchfields, string icid, string lang, string Status)
        {
            List<Nfooter> list;
            string str = "";
            if (orderby.Length < 1)
        ...
        public List<Nfooter> Chekdata(string inid, string Chekdata, DateTime Create_Date, DateTime Modified_Date)
        {
            List<Nfooter> list;
            SqlConnection connection = Database.Connection();
        ...
        public List<Nfooter> DETAIL_Nfooter_RELATED(string inid)
        {
            List<Nfooter> list;
            SqlConnection connection = Database.Connection();
        ...
        public List<Nfooter> Detail_Top(int top, string icid, string lang, string Status)
        {
            List<Nfooter> list;
        ...
        public List<Nfooter> GET_DETAIL_BYICID(string imcid)
        {
            List<Nfooter> list;
        ...
        public List<Nfooter> GETBYALL(string Lang)
        {
            List<Nfooter> list;
            SqlConnection connection = Database.Connection();
        ...
        public List<Nfooter> GETBYID(string inid)
        {
            List<Nfooter> list;
            SqlConnection connection = Database.Connection();
        ...
        public List<Nfooter> GETDETAIL_BYID(string inid)
        {
            List<Nfooter> list;
        ...
        public List<Nfooter> MORE_ICID(string icid)
        {
            List<Nfooter> list;
            SqlConnection connection = Database.Connection();
        ...
        public List<Nfooter> Name_StoredProcedure(string Name_StoredProcedure)
        {
            List<Nfooter> list;
            SqlConnection connection = Database.Connection();
        ...
        public List<Nfooter> Name_Text(string Name_Text)
        {
            List<Nfooter> list;
            SqlConnection connection = Database.Connection();
        ...
        public List<Nfooter> Nfooter_GETBYTOP(string Top, string Where, string Order)
        {
            List<Nfooter> list;
            SqlConnection connection = Database.Connection();
        ...
        public List<Nfooter> Nfooter_INDEX(string lang, string Status)
        {
            List<Nfooter> list;
            SqlConnection connection = Database.Connection();
        ...
        public List<Nfooter> Nfooter_OTHERFIRST(string nid, int top, string lang, string icid)
        {
            List<Nfooter> list;
        ...
        public List<Nfooter> Nfooter_OTHERLAST(string nid, int top, string lang, string icid)
        {
            List<Nfooter> list;
            string cmdText = "select  top " + top.ToString() + " * from Nfooter where Create_Date < (select Create_Date from Nfooter where inid=@nid) and lang=@lang and icid=@icid  and (Create_Date<=getdate() and getdate()<=Modified_Date)  order by Create_Date desc";
            SqlConnection connection = Database.Connection();
        ...
        public List<Nfooter> SEARCH(string keyword, string lang)
        {
            List<Nfooter> list;
        ...
        public List<Nfooter> Text(string Text)
        {
            List<Nfooter> list;
            SqlConnection connection = Database.Connection();
        ...
        public List<Nfooter> Update_datetime(string inid, DateTime Create_Date, DateTime Modified_Date)
        {
            List<Nfooter> list;
            SqlConnection connection = Database.Connection();
        ...
        public List<Nfooter> UPDATE_DATETIME(string inid, string Modified_Date)
        {
            List<Nfooter> list;
        ...
        public List<Nfooter> UPDATE_Nfooter(string Nfooter, string inid)
        {
            List<Nfooter> list;
            SqlConnection connection = Database.Connection();
        ...
        public List<Nfooter> UPDATE_STATUS(string Status, string inid)
        {
            List<Nfooter> list;
            SqlConnection connection = Database.Connection();
        ...
        public List<Nfooter> UPDATE_VIEW_TIME(string inid)
        {
            List<Nfooter> list;
            SqlConnection connection = Database.Connection();
        ...
        public List<Nfooter> SearchNfooter(string keyword, string lang)
        {
            string sql = SearchApproximate.ApproximateSearch(keyword, lang);
            List<Nfooter> list = new List<Nfooter>();
