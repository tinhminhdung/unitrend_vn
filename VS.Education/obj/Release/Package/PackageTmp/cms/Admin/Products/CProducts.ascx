                ...
                <asp:Repeater ID="rp_pagelist" runat="server" OnItemCommand="rp_pagelist_ItemCommand">
                    <ItemTemplate>
                        <tr style="background-color: #f1f1f1" height="40">
                            ...
                            <td align="center">
                                <asp:LinkButton CommandName="ChangeHome" CommandArgument='<%#Eval("ID")+"|"+Eval("page_Home")%>' runat="server" ID="Linkbutton6"><%#MoreAll.MoreAll.Enable(DataBinder.Eval(Container.DataItem, "page_Home").ToString())%></asp:LinkButton>
                            </td>
                         <td align="center">
                                <%if (ShowSua == "1")
                                    {%>
