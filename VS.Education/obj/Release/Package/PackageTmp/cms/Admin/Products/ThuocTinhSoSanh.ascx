<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThuocTinhSoSanh.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Products.ThuocTinhSoSanh" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <%--<div>
        <asp:TextBox ID="TextBox1" runat="server" CssClass="txt_csssearch" Width="400px"></asp:TextBox>
                    ...
                    <ItemTemplate>
                        <tr style="background-color: #f1f1f1" height="40">
                           <td align="center">
                            ...
                            <td align="center">
                                <%#show_menucha(Eval("ShowID").ToString())%>
                            </td>
                            <td>
            ...
            <div class='frm-add'>
                <table style="border-collapse: collapse" cellpadding="0" width="100%" border="0">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                                <asp:DropDownList ID="ddlcategoriesdetail" runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
