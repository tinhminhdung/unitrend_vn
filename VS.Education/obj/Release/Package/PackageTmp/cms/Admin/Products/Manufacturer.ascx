...
<tr>
    ...
    <td>
        ...
        <span style="font-size: 7pt; color: dimgray"><em>(Tên của nhóm danh mục sản phẩm - Ex:Sự kiện,Xã hội,Thế giới)</em></span>
    </td>
</tr>
    ...
    <asp:MultiView ID="MultiView2" runat="server" ActiveViewIndex="0">
        <asp:View ID="vwFromComputer" runat="server">
            <asp:FileUpload CssClass="txt_css" ID="flimage" runat="server" Width="323px" />
              <span style="font-size: 7pt; color: dimgray"><em>(Hình ảnh đại diện của tin theo danh mục - chọn ở mấy tính cá nhân.)</em></span>
            <br />
          </asp:View>
        <asp:View ID="vwFromLinks" runat="server">
            <asp:TextBox CssClass="txt_css" ID="txtvimg" runat="server" Width="99%"></asp:TextBox><br />
            <span style="font-size: 7pt; color: dimgray"><em>(Hình ảnh đại diện của tin theo danh mục - được lấy từ 1 link khác - Ex:http://abc.com/pic/hinhanh.jpg)</em></span>
        </asp:View>
    </asp:MultiView>
    </div>
...
<tr style=" display:none">
    ...
    <td>
       <asp:TextBox ID="txtNoiDung" CssClass="txt_css" runat="server" Width="50%" Height="100px" TextMode="MultiLine"></asp:TextBox>
...
<tr>
    ...
    <td>
        ...
        <span style="font-size: 7pt; color: dimgray"><em>(Được hiển thị theo thứ tự trong phần hiển thị.)</em></span>
    </td>
</tr>
<tr>
    <td align="right">
    ...
    <td>
        ...
        <span style="font-size: 7pt; color: dimgray"><em>(cho phép hiển thị/không hiển thị danh mục.)</em></span></td>
</tr>
<tr>
    <td align="right"></td>
    <td></td>
    <td>
        <asp:Button ID="btn_InsertUpdate" runat="server"  CssClass="txt_css" OnClick="btn_InsertUpdate_Click" Text="Insert/Update" Width="120px" />
        <asp:Button ID="btnCancel" runat="server"  CssClass="txt_css"   OnClick="btnCancel_Click" Text="Cancel" Width="56px" />
    </td>
</tr>
</table>
</div>
