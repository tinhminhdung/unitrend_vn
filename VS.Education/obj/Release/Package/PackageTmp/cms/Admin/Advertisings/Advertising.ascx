    ...
    <asp:View ID="View1" runat="server">
        ...
        <div class="list_item">
            <asp:Repeater ID="rpitems" runat="server" OnItemCommand="rpitems_ItemCommand">
                    ...
                    <tr style="background-color: #f1f1f1" height="40">
                        ...
                        <td align="center">
                            <%if (ShowXoa == "1")
                                {%>
                            <div class="del">
                                <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%#Eval("images")%>' CommandName="delete" OnLoad="Delete_Load">[<%#label("ldelete")%>]</asp:LinkButton>
                            </div>
                            <%} %>
                        </td>
                    </tr>
                ...
                <SeparatorTemplate>
                    <tr>
                        <td bgcolor="#ffffff" colspan="10" height="1"></td>
                    </tr>
                    <tr>
                        <td bgcolor="#30a72f" colspan="10" height="1"></td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff" colspan="10" height="1"></td>
                    </tr>
    ...
    <asp:View ID="View2" runat="server">
        <div class='frm-add'>
            <table id="tblinput" border="0" cellpadding="1" cellspacing="0" class="all" width="100%">
                ...
                <tr>
                    <td align="right" height="3" style="width: 100px"></td>
                    <td align="right" height="3">Mô tả
                    </td>
                    <td></td>
                    <td>
                ...
                <asp:Panel ID="PanelLink01" runat="server">
                    ...
                    <tr>
                        <td align="right" style="width: 100px; height: 43px"></td>
                ...
                <asp:Panel ID="PanelYoutube" runat="server">
                    <tr>
                        <td align="right" height="3" style="width: 100px"></td>
                        <td align="right" height="3">Link Youtube
                        </td>
                        <td></td>
                        <td>
                ...
                <asp:Panel ID="PanelLink04" runat="server">
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <asp:TextBox ID="txtwidth" runat="server" Width="45px">1</asp:TextBox>px<%=label("l_height")%>
                            <asp:TextBox ID="txtheight" runat="server" Width="45px">1</asp:TextBox>px (Default 0px) <span style="font-size: 7pt; color: dimgray"><em>((<%=label("l_0pxshowtruesizeimage")%>) - Sau khi chọn vị trí quảng cáo, Chép lại chiều cao và rộng vào ô)</em></span>
                        </td>
                    </tr>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                        <asp:CheckBox ID="chkdisplaytitle" runat="server" /><%=label("l_showtitle-text")%>
                    </td>
                </tr>
                <tr>
                    <td align="right" height="3" style="width: 100px"></td>
