<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cartdetail.aspx.cs" Inherits="VS.E_Commerce.cms.Admin.ProductsCarts.Cartdetail" %>
  ...
  height:73px">
    ...
    <tr height="23" style="mso-height-source:userset;height:17.25pt">
        ...
        <td class="style9" colspan="5">
           Số 15, ngách 71, ngõ 116 Nguyễn Xiển, Thanh Xuân, Hà Nội</td>
        <td class="style8">
        </td>
    </tr>
    <tr height="23" style="mso-height-source:userset;height:17.25pt">
    ...
    <tr height="26" style="mso-height-source:userset;height:19.5pt">
        <td class="style13" colspan="3" height="26" style="mso-ignore: colspan">
            Thanh toán & vận chuyển: <asp:Literal ID="ltthanhtoan" runat="server"></asp:Literal></td>
        <td class="style14" colspan="6">
    ...
    <tr height="45" style="mso-height-source:userset;height:33.75pt;  background: #d7d7d7 none repeat scroll 0 0;">
        ...
        <td class="style18" width="280">
            Tên Sản phẩm</td>
        <td class="style19" width="80">
            Số lượng</td>
        <td class="style20" width="120">
            Đ.V<br /> tính</td>
        <td class="style21" width="120">
            Đơn giá</td>
	...
	<ItemTemplate>
      <tr height="28" style="mso-height-source:userset;height:21.0pt">
        ...
        <td class="style26"  style='border:1px solid #000'><%#Eval("Donvitinh")%></td>
        <td class="style27" width="65"  style='border:1px solid #000'><%#MoreAll.MorePro.Detail_Price(Eval("Price").ToString())%></td>
            <td class="style26"  style='border:1px solid #000'><%#Eval("Trongluong")%>  Gram</td>
        <td class="style28" width="76"  style='border:1px solid #000'><%#MoreAll.MorePro.Detail_Price(Eval("Money").ToString())%></td>
      <%--  <td class="style29" width="72"  style='border:1px solid #000'><%#Kho(Eval("ipid").ToString())%></td>--%>
    ...
    <tr height="33" style="mso-height-source:userset;height:24.75pt;  background: #d7d7d7 none repeat scroll 0 0;">
        <td class="style30" height="33">
            &nbsp;</td>
        <td class="style31">
            Tổng Số tiền phải thanh toán</td>
        <td class="style32">
            &nbsp;</td>
        <td class="style33" colspan="5">
         
            <asp:Literal ID="lttongsotienthanhtoan" runat="server"></asp:Literal></td>
        <td class="style8" style='background:#fff'>
        </td>
    </tr>
    ...
    <tr height="17" style="height:12.75pt">
        ...
        <td class="style8" colspan="5" style="mso-ignore: colspan">
            Chi tiết vui lòng liên hệ: 04.66858855 - 0946386693</td>
        <td class="style46">
        </td>
        <td class="style8">
        </td>
