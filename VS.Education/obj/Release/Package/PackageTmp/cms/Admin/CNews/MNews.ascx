        ...
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
            <asp:View ID="View1" runat="server">
                <div class="frm_search">
                    ...
                    <div style="margin-top: 10px;">
                        <asp:DropDownList ID="ddlcategories" Visible="false" CssClass="txt" AutoPostBack="true" runat="server" Width="148px" OnSelectedIndexChanged="ddlcategories_SelectedIndexChanged">
                        </asp:DropDownList>
                        ...
                        <ItemTemplate>
                            <tr style="background-color: #f1f1f1" height="40">
                                ...
                                <td align="center">
                                    ...
                                    <div>
                                        <asp:LinkButton ID="LinkButton5" CssClass="lnk" CommandName="Chekdata" CommandArgument='<%#Eval("inid") %>' runat="server"> <%#MoreAll.MoreAll.Enable_Date(DataBinder.Eval(Container.DataItem, "Chekdata").ToString())%></asp:LinkButton>
                                    </div>
                                </td>
                                <td align="center">
                                ...
                                <td align="center">
                                    <asp:LinkButton ID="LinkButton1" CssClass="lnk" CommandName="UpDate" CommandArgument='<%#Eval("inid") %>' runat="server"><img src="/Resources/admin/images/refesh.png" border="0"></asp:LinkButton>
                                </td>
                                <td align="center">
                                ...
                                <td align="center">
                                    <asp:LinkButton CommandName="ChangeNews" CommandArgument='<%#Eval("inid")+"|"+Eval("new")%>' runat="server" ID="Linkbutton6"><%#MoreAll.MoreAll.Enable(DataBinder.Eval(Container.DataItem, "new").ToString())%></asp:LinkButton>
                                </td>
                                <td align="center">
                                    <%if (ShowSua == "1")
                                        {%>
                                    <asp:LinkButton ID="LinkButton2" CssClass="lnk" CommandName="EditDetail" CommandArgument='<%#Eval("inid") %>' runat="server">[ <%=label("lt_edit")%>]</asp:LinkButton>
                                    <%} %>
                                </td>
                                <td align="center">
                                    <%if (ShowXoa == "1")
                                        {%>
                                    <div class="del">
                                        <asp:LinkButton CssClass="lnk" ID="LinkButton3" OnLoad="Delete_Load" CommandName="Delete" CommandArgument='<%#Eval("inid") %>' runat="server">[<%=label("ldelete")%>]</asp:LinkButton>
                                    </div>
                                    <%} %>
                                </td>
            ...
            <asp:View ID="View2" runat="server">
                ...
                <div style="padding-left: 100px; padding-top: 10px;">
                    <asp:Button ID="btnsave" runat="server" Text="Thêm - hiệu chỉnh" OnClick="Button2_Click" Width="122px" />
                    <asp:Button ID="btncancel" runat="server" Text="Hủy bỏ" OnClick="Button1_Click" Width="93px" />
                </div>
