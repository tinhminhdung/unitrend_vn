                ...
                <asp:Repeater ID="rp_pagelist" runat="server" OnItemCommand="rp_pagelist_ItemCommand">
                    <ItemTemplate>
                        <tr style="background-color: #f1f1f1" height="40">
                            ...
                            <td align="center">
                                <asp:LinkButton ID="LinkButton7" CommandName="Tang" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"ID")%>' runat="server">[Tăng]</asp:LinkButton><%#DataBinder.Eval(Container.DataItem,"Orders")%>
                                ...
                                <asp:LinkButton CommandName="ChangeStatus" CommandArgument='<%#Eval("ID")+"|"+Eval("Status")%>'  runat="server" ID="Linkbutton4"><%#MoreAll.MoreAll.Enable(DataBinder.Eval(Container.DataItem, "Status").ToString())%></asp:LinkButton>
                                 ...
                                 <td align="center">
                                <asp:LinkButton CommandName="News" CommandArgument='<%#Eval("ID")+"|"+Eval("News")%>'  runat="server" ID="Linkbutton6"><%#MoreAll.MoreAll.Enable(DataBinder.Eval(Container.DataItem, "News").ToString())%></asp:LinkButton>
                            </td>
                         <td align="center">
                                <%if (ShowSua == "1")
                                    {%>
                    ...
                    <AlternatingItemTemplate>
                        <tr style="background-color: #ffff" height="40">
                            ...
                            <td align="center">
                              ...
                              <td align="center">
                                <asp:LinkButton CommandName="News" CommandArgument='<%#Eval("ID")+"|"+Eval("News")%>'  runat="server" ID="Linkbutton9"><%#MoreAll.MoreAll.Enable(DataBinder.Eval(Container.DataItem, "News").ToString())%></asp:LinkButton>
                            </td>
                          <td align="center">
                                <%if (ShowSua == "1")
                                    {%>
...
<div>
    <div align=left style=" float:left; width:700px">--%>
                    <asp:RadioButton ID="rdFromComputer" Visible="false" runat="server" CssClass="txt_css2" AutoPostBack="True" Checked="true" GroupName="FromType" OnCheckedChanged="rdFromComputer_CheckedChanged" Text="Từ máy tính của bạn" ValidationGroup="downloadtype" />
                    <asp:RadioButton ID="rdFromLinks" Visible="false" runat="server" CssClass="txt_css2" AutoPostBack="True" GroupName="FromType" OnCheckedChanged="rdFromLinks_CheckedChanged" Text="Từ 1 liên kết" />
                    <caption>
                        &nbsp;&nbsp;
                        <asp:Button ID="btDeleteimages" runat="server" CssClass="txt_css" 
                            OnClick="btDeleteimages_Click" Text="Delete" Visible="false" Width="75px" />
                        <br />
                        <asp:MultiView ID="MultiView2" runat="server" ActiveViewIndex="0">
                            <asp:View ID="vwFromComputer" runat="server">
                                <asp:FileUpload ID="flimage" runat="server" CssClass="txt_css" Visible="false" 
                                    Width="323px" />
                            </asp:View>
                            <asp:View ID="vwFromLinks" runat="server">
                                <asp:TextBox ID="txtvimg" runat="server" CssClass="txt_css" Visible="false" 
