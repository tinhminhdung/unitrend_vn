                ...
                <div class="frm_search">
                    ...
                    <div style="margin-top: 10px;">
                        ...
                        <asp:Button ID="bthienthi" runat="server" Text="Hiển thị" OnClick="bthienthi_Click"
                            Width="70px" />
                        <asp:Button ID="btthemmoi" runat="server" Text="Thêm mới" OnClick="btthemmoi_Click"
                            Width="91px" />
                        <asp:Button ID="btDeleteall" ToolTip="Xóa những lựa chọn !" OnClientClick=" return confirmDelete(this);"
                            runat="server" Text="Xóa" OnClick="btDeleteall_Click" Width="34px" />
                    </div>
                </div>
                <div class="list_item">
                        ...
                        <td style="height: 25px">
                            <b>
                                <asp:LinkButton ID="lnkcreatenew" runat="server" CssClass="lnk" Font-Bold="True"
                                    OnClick="lnkcreatenew_Click">[<%=label("l_createnew")%>]</asp:LinkButton></b>
                        </td>
                    </tr>
                </table>
            </asp:View>
