        ...
        protected void rp_pagelist_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "Delete":
                    ...
                    int j;
                    List<Nfooter> dlt = SNfooter.MORE_ICID(More.Sub_Menu(More.IF, str2));
                    ...
                    //Xóa danh mục
                    int k;
                    List<Entity.Menu> str1 = SMenu.MORE_ID(More.Sub_Menu(More.IF, str2));
                    ...
                    #endregion
                    SNfooter.Nfooter_CATE_DELETE_ICID(More.Sub_Menu(More.IF, str2));
            ...
            try
            {
                for (int i = 0; i < rp_pagelist.Items.Count; i++)
                {
                    ...
                    if (chk.Checked)
                    {
                        ...
                        int j;
                        List<Nfooter> dlt = SNfooter.MORE_ICID(More.Sub_Menu(More.IF, id.Value));
                        for (j = 0; j < dlt.Count; j++)
                        {
                            try
                            {
                        ...
                        //Xóa danh mục
                        int k;
                        List<Entity.Menu> str = SMenu.GETPARENT_ID(id.Value, More.Sub_Menu(More.IF, id.Value));
                        ...
                        #endregion
                        SNfooter.Nfooter_CATE_DELETE_ICID(More.Sub_Menu(More.IF, id.Value));
