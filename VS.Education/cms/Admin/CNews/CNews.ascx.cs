        ...
        protected void rp_pagelist_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "Delete":
                    ...
                    int j;
                    List<News> dlt = SNews.MORE_ICID(More.Sub_Menu(More.NS, str2));
                    ...
                    //Xóa danh mục
                    int k;
                    List<Entity.Menu> str1 = SMenu.MORE_ID(More.Sub_Menu(More.NS, str2));
                    ...
                    #endregion
                    SNews.News_CATE_DELETE_ICID(More.Sub_Menu(More.NS, str2));
        ...
        private void UpdateList()
        {
            try
            {
                ...
                else
                {
                    ...
                    if (table.Count > 0)
                    {
                       // this.lbl_curpage.Text = this.label("l_rootcate") + " : " + More.LoadNav(int.Parse(hd_id.Value.Trim()));
                        this.hd_par_id.Value = table[0].Parent_ID.ToString().Trim();
                    }
                }
            }
            ...
            try
            {
                for (int i = 0; i < rp_pagelist.Items.Count; i++)
                {
                    ...
                    if (chk.Checked)
                    {
                        ...
                        int j;
                        List<News> dlt = SNews.MORE_ICID(More.Sub_Menu(More.NS, id.Value));
                        for (j = 0; j < dlt.Count; j++)
                        {
                            try
                            {
                        ...
                        //Xóa danh mục
                        int k;
                        List<Entity.Menu> str = SMenu.GETPARENT_ID(id.Value, More.Sub_Menu(More.NS, id.Value));
                        ...
                        #endregion
                        SNews.News_CATE_DELETE_ICID(More.Sub_Menu(More.NS, id.Value));
                        SMenu.DELETE(More.Sub_Menu(More.NS, id.Value));
                    }
                }
                UpdateList();
            }
