<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="YCBaoGia.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.YCBaoGia.YCBaoGia" %>
                        ...
                        <td align="left" style="padding-left: 10px; line-height: 22px; color: #646465">
                            ...
                            <table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
                                <tr style="border: none !important">
                                    <td style="width: 120px; border: none !important">
                                        <b>Mã báo giá</b>:
                                    </td>
                        ...
                        <td align="left" style="padding-left: 10px; line-height: 22px; color: #646465">
                            ...
                            <table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
                                ...
                                <tr style="border: none !important">
                                    ...
                                    <td style="border: none !important">
                                        <%#File_1(DataBinder.Eval(Container.DataItem, "File1").ToString())%> <%#File_2(DataBinder.Eval(Container.DataItem, "File2").ToString())%>
                                    </td>
                                </tr>
                                <tr style="border: none !important">
                                    <td style="width: 120px; border: none !important">
                                ...
                                <tr style="border: none !important">
                                    ...
                                    <td style="border: none !important">
                                        <b style="color: #67c2ca"><%#DataBinder.Eval(Container.DataItem, "vcontent")%></b>
                                    </td>
                                </tr>
                            </table>
                        </td>
