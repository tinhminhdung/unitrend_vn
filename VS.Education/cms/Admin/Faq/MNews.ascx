                    ...
                    <asp:Repeater ID="rpitems" runat="server" OnItemCommand="rpitems_ItemCommand">
                        ...
                        <ItemTemplate>
                            <tr style="background-color: #f1f1f1" height="40">
                                ...
                                <td align="center">
                                    <div class="del"><asp:LinkButton CssClass="lnk" ID="LinkButton3" OnLoad="Delete_Load" CommandName="Delete" CommandArgument='<%#Eval("inid") %>' runat="server">[<%=label("ldelete")%>]</asp:LinkButton></div>
                                </td>
                            </tr>
                        </ItemTemplate>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CheckBox ID="chknews" runat="server" CssClass="txt_css2" Text="Trang chủ - giới thiệu" />
                            </td>
                        </tr>
                    </table>
                </div>
