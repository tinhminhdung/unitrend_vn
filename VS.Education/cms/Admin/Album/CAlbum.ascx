        ...
        <asp:Panel ID="pn_list" runat="server" Width="100%">
            ...
            <table style="border-collapse: collapse" cellpadding="0" width="100%" border="0">
                ...
                <tr height="25" bgcolor="whitesmoke">
                    <td>
                        <asp:LinkButton ID="LBT_Themmoi" Font-Bold="true" OnClick="LBT_Themmoi_Click" runat="server">[<%=label("l_createnew")%>]</asp:LinkButton>
                    </td>
                </tr>
            </table>
        </asp:Panel>
...
<div>
    <div align=left style=" float:left; width:700px">--%>
                    <asp:RadioButton ID="rdFromComputer" runat="server" Visible="false" CssClass="txt_css2"
                    ...
                    <asp:RadioButton ID="rdFromLinks" runat="server" Visible="false" CssClass="txt_css2"
                        AutoPostBack="True" GroupName="FromType" OnCheckedChanged="rdFromLinks_CheckedChanged"
                        Text="Từ 1 liên kết" />&nbsp;&nbsp;
                    <asp:Button ID="btDeleteimages" Visible="false" runat="server" Text="Delete" OnClick="btDeleteimages_Click"
                        Width="75px" /><br />
    ...
    <div  style=" padding:0px 0px 0px 0px">--%>
                    ...
                    <asp:TextBox ID="txtNoiDung" CssClass="txt_css" Visible="false" runat="server" Width="50%"
