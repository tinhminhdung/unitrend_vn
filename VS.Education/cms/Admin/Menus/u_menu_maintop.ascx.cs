...
{
    public partial class u_menu_maintop : System.Web.UI.UserControl
    {
        ...
        protected void LinkButton4_Click(object sender, EventArgs e)
        {
            ...
            {
                this.txt_order.Text = More.GetNextCateOrder(More.BM, this.lang, "-1").ToString();
            }
            else
            {
                this.txt_order.Text = More.GetNextCateOrder(More.BM, this.lang, hd_id.Value).ToString();
            }
            txturl.Text = "";
        ...
        private void UpdateList()
        {
            ...
            List<Entity.Menu> table = SMenu.CATE_LOADALL_MENU(More.BM, this.lang, this.hd_id.Value.Trim());
        ...
        protected void btxoa2_Click(object sender, EventArgs e)
        {
            try
            {
                for (int i = 0; i < rp_pagelist.Items.Count; i++)
                {
                    ...
                    if (chk.Checked)
                    {
                        SMenu.DELETE(More.Sub_Menu(More.BM, id.Value));
                    }
                }
                UpdateList();
            }
