        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            switch (this.su)
            {
                case "Posts":
                    ...
                    return;
                case "topstaticmenu":
                    phcontrol.Controls.Add(LoadControl("u_menu_maintop.ascx"));
                    return;
                case "botstaticmenu":
                    phcontrol.Controls.Add(LoadControl("u_menu_mainbottom.ascx"));
                    return;
                case "Menuchinh":
                    phcontrol.Controls.Add(LoadControl("u_menu_mainheader.ascx"));
                    return;
