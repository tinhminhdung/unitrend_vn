                ...
                case "Delete":
                    {
                        try
                        {
                            ...
                            int f;
                            List<Product_images> strf = SProduct_images.More_icid(More.Sub_Menu(More.CO, str2));
                            ...
                            //Xóa danh sách hình ảnh sản phẩm
                            int j;
                            List<Entity.Products> dlt = SProducts.More_icid(More.Sub_Menu(More.CO, str2));
                            ...
                            //Xóa danh mục
                            int k;
                            List<Entity.Menu> str1 = SMenu.MORE_ID(More.Sub_Menu(More.CO, str2));
            ...
            try
            {
                for (int i = 0; i < rp_pagelist.Items.Count; i++)
                {
                    ...
                    if (chk.Checked)
                    {
                        ...
                        ////Xóa danh sách hình ảnh sản phẩm
                        int f;
                        List<Product_images> strf = SProduct_images.More_icid(More.Sub_Menu(More.CO, id.Value));
                        ...
                        int j;
                        List<Entity.Products> dlt = SProducts.More_icid(More.Sub_Menu(More.CO, id.Value));
                        for (j = 0; j < dlt.Count; j++)
                        {
                            try
                            {
                        ...
                        //Xóa danh mục
                        int k;
                        List<Entity.Menu> str = SMenu.MORE_ID(More.Sub_Menu(More.CO, id.Value));
