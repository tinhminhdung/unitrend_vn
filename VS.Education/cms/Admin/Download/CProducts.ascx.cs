...
namespace VS.E_Commerce.cms.Admin.Download
{
    public partial class CProducts : System.Web.UI.UserControl
    {
        ...
        protected void LinkButton4_Click(object sender, EventArgs e)
        {
            ...
            {
                this.txt_order.Text = More.GetNextCateOrder(More.TL, this.lang, "-1").ToString();
            }
            else
            {
                this.txt_order.Text = More.GetNextCateOrder(More.TL, this.lang, hd_id.Value).ToString();
            }
                ...
                case "Delete":
                    {
                        try
                        {
                            ...
                            int f;
                            List<Product_images> strf = SProduct_images.More_icid(More.Sub_Menu(More.TL, str2));
                            ...
                            //Xóa danh sách hình ảnh sản phẩm
                            int j;
                            List<Entity.Products> dlt = SProducts.More_icid(More.Sub_Menu(More.TL, str2));
                            ...
                            //Xóa danh mục
                            int k;
                            List<Entity.Menu> str1 = SMenu.MORE_ID(More.Sub_Menu(More.TL, str2));
                            ...
                            #endregion
                            SProduct_images.Cate_Delete_icid(More.Sub_Menu(More.TL, str2));
                            SProducts.Cate_Delete_icid(More.Sub_Menu(More.TL, str2));
                            SMenu.DELETE(More.Sub_Menu(More.TL, str2));
                            this.UpdateList();
                            this.ltmsg.Text = "";
                        }
                        catch (Exception)
        ...
        private void UpdateList()
        {
            try
            {
                ...
                List<Entity.Menu> table = SMenu.CATE_LOADALL_NEWS(More.TL, this.lang, this.hd_id.Value.Trim());
            ...
            try
            {
                for (int i = 0; i < rp_pagelist.Items.Count; i++)
                {
                    ...
                    if (chk.Checked)
                    {
                        ...
                        ////Xóa danh sách hình ảnh sản phẩm
                        int f;
                        List<Product_images> strf = SProduct_images.More_icid(More.Sub_Menu(More.TL, id.Value));
                        ...
                        int j;
                        List<Entity.Products> dlt = SProducts.More_icid(More.Sub_Menu(More.TL, id.Value));
                        for (j = 0; j < dlt.Count; j++)
                        {
                            try
                            {
                        ...
                        //Xóa danh mục
                        int k;
                        List<Entity.Menu> str = SMenu.MORE_ID(More.Sub_Menu(More.TL, id.Value));
                        ...
                        #endregion
                        SProduct_images.Cate_Delete_icid(More.Sub_Menu(More.TL, id.Value));
                        SProducts.Cate_Delete_icid(More.Sub_Menu(More.TL, id.Value));
                        SMenu.DELETE_PARENT(More.Sub_Menu(More.TL, id.Value));
                    }
                }
                UpdateList();
            }
