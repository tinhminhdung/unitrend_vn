...
namespace VS.E_Commerce.cms.Admin.Tinhthanhqh
{
    public partial class Tinhtqh : System.Web.UI.UserControl
    {
                    ...
                    if (str5 != null)
                    {
                        if (!(str5 == "update"))
                        {
                            if (str5 == "insert")
                            {
                                ...
                                obj.Check_04 = 0;
                                obj.Check_05 = 0;
                                obj.Noidung1 = txtgia.Text;
                                obj.Noidung2 = "";
                                obj.Noidung3 = "";
                                obj.Noidung4 = "";
                                obj.Noidung5 = "";
                                obj.Module = 20;
                                obj.TangName = MoreAll.AddURL.SeoURL(txt_title.Text);
                                #endregion
        ...
        protected void LinkButton4_Click(object sender, EventArgs e)
        {
            ...
            {
                this.txt_order.Text = More.GetNextCateOrder(More.TT, this.lang, "-1").ToString();
            }
            else
            {
                this.txt_order.Text = More.GetNextCateOrder(More.TT, this.lang, hd_id.Value).ToString();
            }
        ...
        protected void rp_pagelist_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                #region EditDetail
                case "EditDetail":
                    List<Entity.Tinhthanh> table = STinhthanh.GETBYID(str2);
                    ...
                    if (table.Count > 0)
                    {
                        ...
                        if (table.Count > 0)
                        {
                            ...
                            this.txtgia.Text = table[0].Noidung1.ToString().Trim();
                            #region Seowwebsite
                ...
                case "ListChildren":
                    ...
                    {
                        string nva = "";
                        this.lbl_curpage.Text = LoadNav(_cid, ref nva);
                    }
                    this.UpdateList();
                    return;
                case "ChangeStatus":
                ...
                case "News":
                    {
                        ...
                        STinhthanh.UpdateTinhthanh(str2, "News", str33);
                        this.UpdateList();
                    }
                    return;
                case "page_Home":
                    {
                        ...
                        STinhthanh.UpdateTinhthanh(str2, "page_Home", str344);
                        this.UpdateList();
                    }
                    return;
                case "Tang":
        ...
        public string LoadNav(int ID, ref string nav)
        {
            var item = STinhthanh.Name_Text("select * from Tinhthanh where id=" + ID + "");
            if (item != null)
            {
        ...
        private void UpdateList()
        {
            try
            {
                ...
                List<Entity.Tinhthanh> table = STinhthanh.CATE_LOADALL_NEWS(More.TT, this.lang, this.hd_id.Value.Trim());
                ...
                {
                    List<Entity.Tinhthanh> str = STinhthanh.Detail(this.hd_id.Value.Trim());
                    if (str.Count > 0)
                    {
        ...
        protected void btxoa_Click(object sender, EventArgs e)
        {
            try
            {
                for (int i = 0; i < rp_pagelist.Items.Count; i++)
                {
                    ...
                    if (chk.Checked)
                    {
                        STinhthanh.DELETE_PARENT(id.Value);
                    }
                }
                UpdateList();
            }
        ...
        {
            List<Entity.Tinhthanh> table = STinhthanh.GETBYID(hdid.Value);
            if (table.Count > 0)
            {
                File.Delete(AppDomain.CurrentDomain.BaseDirectory + "/" + table[0].Images);
            }
            STinhthanh.Name_Text("update Tinhthanh set Images='' where ID=" + hdid.Value + "");
            this.txtvimg.Text = "";
            this.hdFileName.Value = "";
            this.ltimg.Text = "";
            this.txtcontent.Text = "";
