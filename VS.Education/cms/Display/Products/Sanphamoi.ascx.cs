...
{
    public partial class Sanphamoi : System.Web.UI.UserControl
    {
        ...
        {
            List<Entity.Products> dt = SProducts.Name_Text("select  * from  products where  News=1 and Status=1 and  lang='" + language + "' order by Create_Date desc");
            if (dt.Count > 0)
            {
