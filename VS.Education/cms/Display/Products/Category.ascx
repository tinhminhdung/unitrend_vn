                                ...
                                <div class="col-md-2 col-sm-3 col-xs-12 no-padding">
                                    <div class="product-item">
                                        ...
                                        <div class="pro-content">
                                            ...
                                            <a href="javascript:;" onclick="btnaddcompare('<%#Eval("ipid") %>','<%#Eval("icid") %>','<%#Eval("Name") %>','<%#Eval("ImagesSmall") %>','<%#Eval("Price") %>','<%#Show_menu(Eval("icid").ToString()) %>')" class="item-ss"><i></i> So sánh</a>
