...
namespace Services
{
    public class SDownload
    {
        ...
        public static List<Download> CATEGORY_ADMIN(string orderby, string searchkeyword,string icid, string[] searchfields, string lang, string Status)
        {
            return db.CATEGORY_ADMIN(orderby, searchkeyword, icid, searchfields, lang, Status);
        }
